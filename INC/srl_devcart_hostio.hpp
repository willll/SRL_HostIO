...
namespace SRL
{
    ...
    namespace DevCart
    {
        ...
        namespace HostIo
        {
             ...
             */
            constexpr static uint8_t Magic0 = 'S';
            /** @brief Magic character 1 ('R').
             */
            constexpr static uint8_t Magic1 = 'R';
            /** @brief Magic character 2 ('L').
             */
            constexpr static uint8_t Magic2 = 'L';
            /** @brief Magic character 3 ('1').
             */
            constexpr static uint8_t Magic3 = '1';

            /** @brief Total size in bytes of the protocol frame header.
             */
            constexpr static size_t HeaderSize = 7;
                ...
                size_t payloadCapacity, size_t &payloadSize)
            {
                ...
                uint8_t payloadLenBuf[2] = {header[6], header[5]};
                const uint16_t payloadLen = SRL::Endian::DeserializeUint16(payloadLenBuf);
